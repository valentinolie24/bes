...
@section('subcontent')
    ...
    <div class="intro-y box mt-5 flex flex-col lg:flex-row">
        <div class="intro-y flex-1 px-5 py-16">
            ...
            <div class="flex justify-center">
                <div class="relative mx-auto mt-8 text-5xl font-semibold">
                    <span class="absolute top-0 left-0 -ml-4 text-2xl">$</span> 35
                </div>
            </div>
            <x-base.button
        ...
        <div
            class="intro-y flex-1 border-t border-b border-slate-200/60 p-5 py-16 dark:border-darkmode-400 lg:border-b-0 lg:border-t-0 lg:border-l lg:border-r">
            <x-base.lucide
                class="mx-auto block h-12 w-12 text-primary"
                icon="Briefcase"
            />
            ...
            <div class="flex justify-center">
                <div class="relative mx-auto mt-8 text-5xl font-semibold">
                    <span class="absolute top-0 left-0 -ml-4 text-2xl">$</span> 60
                </div>
            </div>
            <x-base.button
                class="mx-auto mt-8 block px-4 py-3"
        ...
        <div class="intro-y flex-1 px-5 py-16">
            ...
            <div class="flex justify-center">
                <div class="relative mx-auto mt-8 text-5xl font-semibold">
                    <span class="absolute top-0 left-0 -ml-4 text-2xl">$</span>
                    120
                </div>
            </div>
            <x-base.button
    ...
    <div class="intro-y box mt-5 flex flex-col lg:flex-row">
        ...
        <div
            class="intro-y flex-1 border-t border-b border-slate-200/60 px-5 py-16 dark:border-darkmode-400 lg:border-b-0 lg:border-t-0 lg:border-l lg:border-r">
            <x-base.lucide
                class="mx-auto block h-12 w-12 text-primary"
                icon="Box"
            />
