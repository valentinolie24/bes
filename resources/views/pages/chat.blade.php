        ...
        <x-base.tab.group class="col-span-12 lg:col-span-4 2xl:col-span-3">
            ...
            <x-base.tab.panels>
                ...
                >
                    ...
                    <div class="chat-list scrollbar-hidden mt-4 h-[525px] overflow-y-auto pt-1 pr-1">
                ...
                <x-base.tab.panel id="friends">
                    ...
                    <div class="scrollbar-hidden h-[525px] overflow-y-auto pt-1 pr-1">
            ...
            <div class="chat-box box h-[782px]">
                ...
                <div class="flex hidden h-full flex-col">
                    ...
                    <div class="scrollbar-hidden flex-1 overflow-y-scroll px-5 pt-5">
                        ...
                        <div class="clear-both"></div>
                        <div class="mt-5 mb-10 text-center text-xs text-slate-400 dark:text-slate-500">
                            12 June 2020
                        </div>
                        <div class="float-left mb-4 flex max-w-[90%] items-end sm:max-w-[49%]">
                            <div class="image-fit relative mr-5 hidden h-10 w-10 flex-none sm:block">
                    ...
                    <div
                        class="flex items-center border-t border-slate-200/60 pt-4 pb-10 dark:border-darkmode-400 sm:py-4">
                        ...
                        ></x-base.form-textarea>
                        <div class="absolute bottom-0 left-0 mb-5 ml-5 flex sm:static sm:ml-0 sm:mb-0">
                            <x-base.menu
                                class="mr-3 sm:mr-5"
                                placement="top-end"
                            >
