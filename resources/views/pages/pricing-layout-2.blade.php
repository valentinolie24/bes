...
@section('subcontent')
    <h2 class="intro-y mt-10 mr-auto text-center text-2xl font-medium">
        Best Price & Services
    </h2>
    <x-base.tab.group>
        <!-- BEGIN: Pricing Tab -->
        ...
        <div class="mt-10 flex">
            <x-base.tab.panels>
                ...
                >
                    ...
                    <div class="intro-y box mb-5 flex-1 py-16 lg:ml-5 lg:mb-0">
                        <x-base.lucide
            ...
            <div class="mt-10 flex">
                <x-base.tab.panels>
                    ...
                    >
                        ...
                        <div
                            class="intro-y flex-1 border-t border-b border-slate-200/60 py-16 dark:border-darkmode-400 lg:ml-8 lg:border-t-0 lg:border-b-0 lg:border-l lg:border-r">
                            <x-base.lucide
                                class="mx-auto block h-12 w-12 text-primary"
                                icon="Briefcase"
                            />
